...
Original file is located at
    https://colab.research.google.com/drive/1EGMc8s1Si3QmCT9ln8ukqmIQ2VpSEPpz
"""
...
st.title("Multi-Turn Chatbot Streamlit App using Langchain and OpenAI API")
    ...
    if pages:
        ...
        if api:
            ...
            query = st.text_input(
                ...
                placeholder="Ask the bot anything from {}".format(name_of_file),
            )
            ...
            with st.expander("History/Memory"):
                ...
                # Display conversation history and other memory information
